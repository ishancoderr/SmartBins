...
namespace CesiumForUnity
{
    public partial class CesiumSimplePlanarEllipsoidCurve : System.IDisposable
    {
        ...
        private partial bool CreateFromEarthCenteredEarthFixedCoordinates(Unity.Mathematics.double3 sourceEcef, Unity.Mathematics.double3 destinationEcef)
        {
            unsafe
            {
                if (this._implementation == null || this._implementation.IsInvalid)
                    throw new NotImplementedException("The native implementation is missing so CreateFromEarthCenteredEarthFixedCoordinates cannot be invoked. This may be caused by a missing call to CreateImplementation in one of your constructors, or it may be that the entire native implementation shared library is missing or out of date.");
                var result = DotNet_CesiumForUnity_CesiumSimplePlanarEllipsoidCurve_CreateFromEarthCenteredEarthFixedCoordinates(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, &sourceEcef, &destinationEcef);
                return result != 0;
            }
        }
        private partial bool CreateFromLongitudeLatitudeHeight(Unity.Mathematics.double3 sourceLlh, Unity.Mathematics.double3 destinationLlh)
        {
            unsafe
            {
                if (this._implementation == null || this._implementation.IsInvalid)
                ...
                var result = DotNet_CesiumForUnity_CesiumSimplePlanarEllipsoidCurve_CreateFromLongitudeLatitudeHeight(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation, &sourceLlh, &destinationLlh);
                return result != 0;
            }
        }
        ...
        [DllImport("CesiumForUnityNative-Runtime", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern byte DotNet_CesiumForUnity_CesiumSimplePlanarEllipsoidCurve_CreateFromEarthCenteredEarthFixedCoordinates(System.IntPtr thiz, CesiumForUnity.CesiumSimplePlanarEllipsoidCurve.ImplementationHandle implementation, Unity.Mathematics.double3* sourceEcef, Unity.Mathematics.double3* destinationEcef);
        [DllImport("CesiumForUnityNative-Runtime", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern byte DotNet_CesiumForUnity_CesiumSimplePlanarEllipsoidCurve_CreateFromLongitudeLatitudeHeight(System.IntPtr thiz, CesiumForUnity.CesiumSimplePlanarEllipsoidCurve.ImplementationHandle implementation, Unity.Mathematics.double3* sourceLlh, Unity.Mathematics.double3* destinationLlh);
    }
}
#endif
