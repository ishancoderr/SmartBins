    ...
    public partial class Cesium3DTileset : System.IDisposable
    {
        ...
        internal partial void UpdateOverlayMaterialKeys()
        {
            unsafe
            {
                ...
                DotNet_CesiumForUnity_Cesium3DTileset_UpdateOverlayMaterialKeys(Reinterop.ObjectHandleUtility.CreateHandle(this), _implementation);
            }
        }
        ...
        [DllImport("CesiumForUnityNative-Runtime", CallingConvention=CallingConvention.Cdecl)]
        private static unsafe extern void DotNet_CesiumForUnity_Cesium3DTileset_UpdateOverlayMaterialKeys(System.IntPtr thiz, CesiumForUnity.Cesium3DTileset.ImplementationHandle implementation);
    }
}
#endif
