    ...
    internal class ReinteropInitializer
    {
        ...
        private static void AddFunctionPointers(IntPtr memory)
        {
            unsafe
            {
                ...
                Marshal.WriteIntPtr(memory, 231 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorWindow_CallClose_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 232 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorWindow_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 233 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_EditorWindow_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 234 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_MultiColumnHeader_CallIsSortedAscending_ZiJhFqE0LPDoV__RgQlNVpQDelegate));
                Marshal.WriteIntPtr(memory, 235 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_MultiColumnHeader_Property_get_sortedColumnIndexDelegate));
                Marshal.WriteIntPtr(memory, 236 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_MultiColumnHeader_Property_set_sortedColumnIndexDelegate));
                Marshal.WriteIntPtr(memory, 237 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeView_CallReload_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 238 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeView_Property_get_multiColumnHeaderDelegate));
                Marshal.WriteIntPtr(memory, 239 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeView_Property_get_searchStringDelegate));
                Marshal.WriteIntPtr(memory, 240 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeView_Property_set_multiColumnHeaderDelegate));
                Marshal.WriteIntPtr(memory, 241 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeView_Property_set_searchStringDelegate));
                Marshal.WriteIntPtr(memory, 242 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeViewItem_Construct_fAkE2H7EjTzReHiM2XHBPADelegate));
                Marshal.WriteIntPtr(memory, 243 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeViewItem_Property_get_idDelegate));
                Marshal.WriteIntPtr(memory, 244 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeViewItem_Property_set_idDelegate));
                Marshal.WriteIntPtr(memory, 245 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_IMGUI_Controls_TreeViewState_Construct_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 246 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 247 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 248 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_ScriptableSingletonJeuqFJLwkONU3mMa_RvkKg_Property_get_instanceDelegate));
                Marshal.WriteIntPtr(memory, 249 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_Selection_Property_get_activeGameObjectDelegate));
                Marshal.WriteIntPtr(memory, 250 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEditor_Selection_Property_set_activeGameObjectDelegate));
                Marshal.WriteIntPtr(memory, 251 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_CallOpenURL_i4__FgVIR5VYHO4KBzPBwNQDelegate));
                Marshal.WriteIntPtr(memory, 252 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_Property_get_platformDelegate));
                Marshal.WriteIntPtr(memory, 253 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_Property_get_productNameDelegate));
                Marshal.WriteIntPtr(memory, 254 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_Property_get_temporaryCachePathDelegate));
                Marshal.WriteIntPtr(memory, 255 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_Property_get_unityVersionDelegate));
                Marshal.WriteIntPtr(memory, 256 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Application_Property_get_versionDelegate));
                Marshal.WriteIntPtr(memory, 257 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_AsyncOperation_Calladd_completed_89b__Riirtgd1Q5mmRzPojADelegate));
                Marshal.WriteIntPtr(memory, 258 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_AsyncOperation_Callremove_completed_89b__Riirtgd1Q5mmRzPojADelegate));
                Marshal.WriteIntPtr(memory, 259 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Component_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 260 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Component_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 261 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Component_Property_get_gameObjectDelegate));
                Marshal.WriteIntPtr(memory, 262 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Debug_CallLog_FA05wu8x__otZNsgdHTnU9ADelegate));
                Marshal.WriteIntPtr(memory, 263 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Debug_CallLogError_FA05wu8x__otZNsgdHTnU9ADelegate));
                Marshal.WriteIntPtr(memory, 264 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Debug_CallLogWarning_FA05wu8x__otZNsgdHTnU9ADelegate));
                Marshal.WriteIntPtr(memory, 265 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallAddComponent_0EgxpGTzCG1YTfWqwgLniwDelegate));
                Marshal.WriteIntPtr(memory, 266 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallAddComponent_BAtcoWNWVoAVplmna6OgsQDelegate));
                Marshal.WriteIntPtr(memory, 267 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallGetComponent_0EgxpGTzCG1YTfWqwgLniwDelegate));
                Marshal.WriteIntPtr(memory, 268 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallGetComponent_BAtcoWNWVoAVplmna6OgsQDelegate));
                Marshal.WriteIntPtr(memory, 269 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallGetComponents_BAtcoWNWVoAVplmna6OgsQDelegate));
                Marshal.WriteIntPtr(memory, 270 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_CallGetComponents_H1UZCBm__Pf6NnqpE7xQ8NQDelegate));
                Marshal.WriteIntPtr(memory, 271 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 272 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 273 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GameObject_Construct_wfPSjxsETIcebv8un8PGZwDelegate));
                Marshal.WriteIntPtr(memory, 274 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_GUI_CallLabel_iRU7t71QqJzkr4BTYehN9ADelegate));
                Marshal.WriteIntPtr(memory, 275 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_DownloadHandler_CallDispose_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 276 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_CallGet_Y2__l4HVQ8CbSg4jpXDip9ADelegate));
                Marshal.WriteIntPtr(memory, 277 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_CallGetResponseHeader_wfPSjxsETIcebv8un8PGZwDelegate));
                Marshal.WriteIntPtr(memory, 278 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_CallGetResponseHeaders_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 279 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_CallSendWebRequest_1B2M2Y8AsgTpgAmY7PhCfgDelegate));
                Marshal.WriteIntPtr(memory, 280 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_CallSetRequestHeader_tEfBle3aSdR47_HxLakNjwDelegate));
                Marshal.WriteIntPtr(memory, 281 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Construct_N5nF6s7__PflIcgtgQgj6DADelegate));
                Marshal.WriteIntPtr(memory, 282 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_downloadHandlerDelegate));
                Marshal.WriteIntPtr(memory, 283 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_errorDelegate));
                Marshal.WriteIntPtr(memory, 284 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_isDoneDelegate));
                Marshal.WriteIntPtr(memory, 285 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_methodDelegate));
                Marshal.WriteIntPtr(memory, 286 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_responseCodeDelegate));
                Marshal.WriteIntPtr(memory, 287 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_resultDelegate));
                Marshal.WriteIntPtr(memory, 288 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_get_urlDelegate));
                Marshal.WriteIntPtr(memory, 289 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_set_downloadHandlerDelegate));
                Marshal.WriteIntPtr(memory, 290 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_set_methodDelegate));
                Marshal.WriteIntPtr(memory, 291 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequest_Property_set_urlDelegate));
                Marshal.WriteIntPtr(memory, 292 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequestAsyncOperation_Calladd_completed_89b__Riirtgd1Q5mmRzPojADelegate));
                Marshal.WriteIntPtr(memory, 293 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UnityWebRequestAsyncOperation_Callremove_completed_89b__Riirtgd1Q5mmRzPojADelegate));
                Marshal.WriteIntPtr(memory, 294 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UploadHandlerRaw_Construct_j9VUe_obWzqxHm0yKnVCmgDelegate));
                Marshal.WriteIntPtr(memory, 295 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Networking_UploadHandlerRaw_Construct_Wn8TTeG3Q36ufSfvO3m1sgDelegate));
                Marshal.WriteIntPtr(memory, 296 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Object_CallDestroyImmediate_c5oFMRh3nzKMIo8On83YBgDelegate));
                Marshal.WriteIntPtr(memory, 297 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Object_CallDestroyImmediate_x7aQMuJcEpatC9689ghI4ADelegate));
                Marshal.WriteIntPtr(memory, 298 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Object_CallFindObjectsOfType_0EgxpGTzCG1YTfWqwgLniwDelegate));
                Marshal.WriteIntPtr(memory, 299 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Object_Callop_Equality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 300 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Object_Callop_Inequality_5bi2N6jTkaYVhpHPRxL2WgDelegate));
                Marshal.WriteIntPtr(memory, 301 * sizeof(IntPtr), Marshal.GetFunctionPointerForDelegate(UnityEngine_Rect_Construct_SWzoP__nNh7g2zNwjI5mUvQDelegate));
            }
        }
        ...
        static ReinteropInitializer()
        {
            unsafe
            {
                IntPtr memory = Marshal.AllocHGlobal(sizeof(IntPtr) * 302);
                AddFunctionPointers(memory);
                byte success = initializeReinterop(11624998826531908230UL, memory, 302);
                if (success == 0)
    ...
    internal class ReinteropInitializer
    {
        ...
        static ReinteropInitializer()
        {
            unsafe
            {
                IntPtr memory = Marshal.AllocHGlobal(sizeof(IntPtr) * 302);
                AddFunctionPointers(memory);
                byte success = initializeReinterop(5335570263113069296UL, memory, 302);
                if (success == 0)
                    throw new NotImplementedException("The native library is out of sync with the managed one.");
            }
        }
